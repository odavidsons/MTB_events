      ...
      <form class="criar_utilizador" action="" method="POST">
        ...
        <div class="caixa_registo">
          ...
          <select name="tipo" id="tipo">
            ...
            <option value="<?php echo $tipo ?>" selected><?php if ($tipo == 1) {
                 echo "Administrador";
               } else {
                 echo "Normal";
               } ?>
        ...
        <div class="caixa_registo">
          ...
          <select name="ativo" id="ativo">
            ...
            <option value="<?php echo $ativo ?>" selected><?php if ($ativo == 1) {
                 echo "Sim";
               } else {
                 echo "Não";
               } ?></option>
